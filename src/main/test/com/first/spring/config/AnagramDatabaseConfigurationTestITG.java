...
import static com.anagram.jpa.Anagram.TRANSACTION_MANAGER_NAME;
...
import com.anagram.spring.config.AnagramDatabaseConfiguration;
...
//		JPA.HIBERNATE_PROPERTIES.put("hibernate.hbm2ddl.auto", "validate");
	...
	public void should_test_init_spring_conf() {
		final ApplicationContext applicationContext = new AnnotationConfigApplicationContext(AnagramDatabaseConfiguration.class);
		assertTrue(applicationContext.containsBean("anagramEntityManagerFactory"));
		assertTrue(applicationContext.containsBean(TRANSACTION_MANAGER_NAME));
		assertTrue(applicationContext.containsBean("anagramDataSource"));
	}
